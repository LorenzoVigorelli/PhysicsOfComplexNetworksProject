...
\AddToShipoutPictureBG*{\AtPageLowerLeft{%
  \put(10,10){% <--
    \begin{turn}{90} 
      ...
      \textbf{\color{white} Physics of Complex Networks: Structure and Dynamics}
    \end{turn}
  }%
}}
...
& \textcolor{unipd}{\textbf{\huge PoCN Projects }}\\ % Here the title of your project \\
%& \large \emph{Physics of Complex Networks: Structure and Dynamics}\\
%& \\ 
%& \large \textbf{Surname, name....}\\
& \textbf{Vigorelli, Lorenzo}\\
& \\
& \\
